...
export default function CaptureSummary({
  ...
  return (
    <div className="flex flex-col gap-8 pb-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="px-8 py-5 border-b border-theme bg-slate-500/[0.02] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="inline-flex items-center px-4 py-2 bg-emerald-500/8 border border-emerald-500/20 rounded-none">
              <span className="font-sans font-semibold text-emerald-700 ">PCAP Connection Logs</span>
            </div>
          </div>
          <div className="flex items-center gap-4">
                ...
                {Array.from({ length: Math.min(5, tp) }, (_, i) => {
                  ...
                  if (tp <= 5) pageNum = i + 1;
                    ...
                    <button
                      ...
                      className={`w-8 h-8 flex items-center justify-center font-sans transition-all border ${connectionsPage === pageNum
